...
Label(win, text="Login Page", font=("Roman", 16), image=bg_login).place(x=20, y=10)
...
Label(win, text="Home Page", font=("Roman", 16), image=bg_hp).place(x=20, y=10)
...
Label(win, text="Person Information", font=("Roman", 16), image=bg_pers).place(x=20, y=10)
...
Label(win, text="Transaction Info", font=("Roman", 16), image=bg_tran).place(x=20, y=10)
